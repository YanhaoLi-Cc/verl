...
# Suppress the config registration error
...
train_prompt_bsz=8 # Reduced from 512 to 64 for single node
val_prompt_bsz=8
n_resp_per_prompt=4
...
RAY_DATA_HOME=${RAY_DATA_HOME:-"/home/liyanhao/codebase/verl"}
MODEL_PATH=${MODEL_PATH:-"/mnt/moonfs/liyanhao-ksyun/models/Qwen/Qwen3-4B-Thinking-2507"}
CKPTS_DIR=${CKPTS_DIR:-"/mnt/moonfs/liyanhao-ksyun/checkpoint/${project_name}/${exp_name}"}
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/dapo-math-17k.parquet"}
TEST_FILE=${TEST_FILE:-"${RAY_DATA_HOME}/data/aime-2024-subset-8.parquet"}
...
sp_size=2  # Reduced from 4 to 2 for single node
